...
namespace ReservationSystem2022.Repositories
{
    public class ItemRepository : IItemRepository
    {
        ...
        {
            return await _context.Items.Include(i => i.Images).Include(i => i.Owner).ToListAsync();
            
        }

        public async Task<IEnumerable<Item>> GetItemsAsync(User user) //tässä haetaan items jonka owner on owner user
        {
